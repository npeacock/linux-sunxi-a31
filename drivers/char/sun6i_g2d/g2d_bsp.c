...
__u32 mixer_premultiply_set(__u32 flag)
{
	...
	//src premultiply, dst non-premultiply, dst_c = src_c + dst_c*(1-src_a)/A;A = src_a + dst_a*(1-src_a)
	...
	//src non-premultiply, dst(out) premultiply,dst_c = src_c*src_a + dst_c*dst_a(1-src_a);A = src_a + dst_a*(1-src_a)
