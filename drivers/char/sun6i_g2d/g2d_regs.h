...
#define G2D_DMA0_MBCTL_REG		(0x130)		/* Input DMA0 micro block control register	*/
#define G2D_DMA1_MBCTL_REG		(0x134)		/* Input DMA1 micro block control register	*/
#define G2D_DMA2_MBCTL_REG		(0x138)		/* Input DMA2 micro block control register	*/
#define G2D_DMA3_MBCTL_REG		(0x13c)		/* Input DMA3 micro block control register	*/

#define G2D_CMDQ_CTL_REG		(0x140)		/* command queue control register	*/
#define G2D_CMDQ_STS_REG		(0x144)		/* command queue status register	*/
#define G2D_CMDQ_ADDR_REG		(0x148)		/* command queue storage start address register	*/
