...
#define DEV_DBG_EN   		0
#if(DEV_DBG_EN == 1)
#define csi_dev_dbg(x,arg...) printk("[CSI_DEBUG][GC0308]"x,##arg)
#else
#define csi_dev_dbg(x,arg...)
#endif
#define csi_dev_err(x,arg...) printk("[CSI_ERR][GC0308]"x,##arg)
#define csi_dev_print(x,arg...) printk("[CSI][GC0308]"x,##arg)
