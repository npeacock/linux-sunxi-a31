...
#define DEV_DBG_EN      0 
#if(DEV_DBG_EN == 1)    
#define vfe_dev_dbg(x,arg...) printk("[s5k4ec]"x,##arg)
#else
#define vfe_dev_dbg(x,arg...) 
#endif
#define vfe_dev_err(x,arg...) printk("[s5k4ec]"x,##arg)
#define vfe_dev_print(x,arg...) printk("[s5k4ec]"x,##arg)
...
//wits #define CLK_POL           V4L2_MBUS_PCLK_SAMPLE_RISING
    ...
    unsigned short *value)
{
  ...
  ret = cci_read_a16_d16(client,reg,value);
  while(ret!=0&&cnt<2)
  {
  	ret = cci_read_a16_d16(client,reg,value);
  	cnt++;
    ...
    unsigned short value)
{
  ...
  ret = cci_write_a16_d16(client,reg,value);
  while(ret!=0&&cnt<2)
  {
  	ret = cci_write_a16_d16(client,reg,value);
  	cnt++;
